...
Ruuncoin is a lite version of Bitcoin using scrypt as a proof-of-work algorithm.
...
Ruuncoin is released under the terms of the MIT license. See `COPYING` for more
