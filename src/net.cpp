...
bool CNode::Misbehaving(int howmuch)
{
    ...
    {
        int64 banTime = GetTime()+GetArg("-bantime", 60*60*24);
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ruuncoin " + FormatFullVersion();
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ruuncoin is probably already running."), addrBind.ToString().c_str());
        else
